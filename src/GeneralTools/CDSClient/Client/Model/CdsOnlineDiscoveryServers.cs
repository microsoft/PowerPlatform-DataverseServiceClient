...
namespace Microsoft.PowerPlatform.Cds.Client.Model
{
	...
	public class CdsDiscoveryServers : INotifyPropertyChanged , IDisposable
	{
		...
		public CdsDiscoveryServers()
		{
			...
			_OSDPServers.Add(new CdsDiscoveryServer() { DiscoveryServer = new Uri("https://disco.crm.dynamics.cn/XRMServices/2011/Discovery.svc"), DisplayName = "China", ShortName = "CHN", GeoCode="CHN", RegionalGlobalDiscoveryServer = new Uri("https://globaldisco.crm.dynamics.cn") });
			...
			_OSDPServers.Add(new CdsDiscoveryServer() { DiscoveryServer = new Uri("https://disco.crm9.dynamics.com/XRMServices/2011/Discovery.svc"), DisplayName = "North America 2", ShortName = "NorthAmerica2", RegionalGlobalDiscoveryServer = new Uri("https://globaldisco.crm9.dynamics.com")});
			...
			_OSDPServers.Add(new CdsDiscoveryServer() { DiscoveryServer = new Uri("https://disco.crm.appsplatform.us/XRMServices/2011/Discovery.svc"), DisplayName = "US Gov DoD", ShortName = "DoD", GeoCode= "DOD", RegionalGlobalDiscoveryServer = new Uri("https://globaldisco.crm.appsplatform.us")});
			_OSDPServers.Add(new CdsDiscoveryServer() { DiscoveryServer = new Uri("https://disco.crm.microsoftdynamics.us/XRMServices/2011/Discovery.svc"), DisplayName = "US Gov High", ShortName = "USG", GeoCode = "USG" , RegionalGlobalDiscoveryServer = new Uri("https://globaldisco.crm.microsoftdynamics.us")});
