...
namespace LiveTestsConsole
{
    public class TokenRefresh
    {
        ...
        internal void Run()
        {
            ...
            var client1 = new ServiceClient(userName, ServiceClient.MakeSecureString(password), new Uri(connectionUrl), true, SampleClientId, new Uri(SampleRedirectUrl), PromptBehavior.Never);
