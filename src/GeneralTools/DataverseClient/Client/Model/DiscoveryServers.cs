...
namespace Microsoft.PowerPlatform.Dataverse.Client.Model
{
    ...
    public class DiscoveryServers : INotifyPropertyChanged, IDisposable
    {
        ...
        public DiscoveryServers()
        {
            ...
            _OSDPServers.Add(new DiscoveryServer() { DiscoveryServerUri = new Uri("https://disco.crm21.dynamics.com/XRMServices/2011/Discovery.svc"), DisplayName = "Korea", ShortName = "KOR", GeoCode = "KOR" });
            ...
            _OSDPServers.Add(new DiscoveryServer(internalEnvInfo.DataverseInternalTest));
